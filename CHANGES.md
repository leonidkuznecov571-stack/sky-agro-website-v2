...
About timeline band: changed background from `--color-green-deep` to `--color-green-dark` to reduce visual weight while keeping the section within the brand green palette.
About story section: changed the heading to “Our Journey Started with Malt”, restored the standard H2 scale and weight in white, added the standard eyebrow label, and increased the intro copy weight for stronger hierarchy.
